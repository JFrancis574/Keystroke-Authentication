...
Finally the data is in a state where we can compare the two signals produced. In order to improve the accuracy of the program, I use two different validation methods along with the semantics collected in the word forming stage. 
