...
Figure \ref{fig:decGraph} is a less important graph. It plots the decision made with a confidence interval of 0.8 against the hold time input. 1.0 represents a true decision whilst 0 a False decision. This graph maintains a bell shaped curve that follows closely the 2D correlation co-efficient graph.
